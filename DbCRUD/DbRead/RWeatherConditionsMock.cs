...
namespace AlwaysInTarget.DbCRUD.DbRead
{
    class RWeatherConditionsMock
    {
        ...
        {
            output.Add(new WeatherConditionM { Alt = 0, WindFrom = 100, WindStregngth = 11.0M });
            output.Add(new WeatherConditionM { Alt = 500, WindFrom = 105, WindStregngth = 14.0M });
            output.Add(new WeatherConditionM { Alt = 1000, WindFrom = 110, WindStregngth = 19.0M });
            output.Add(new WeatherConditionM { Alt = 2000, WindFrom = 130, WindStregngth = 21.0M });
            output.Add(new WeatherConditionM { Alt = 5000, WindFrom = 100, WindStregngth = 25.0M });
